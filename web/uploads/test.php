...
class Crawler
{
    ...
    public function run(){
        ...
        $this->crawlSubPages($pageContent, 3);
//        var_dump($this->pages);
    ...
    public function crawlSubPages(Page $page, $deep = 2)
    {
        ...
        foreach ($page->getLinks() as $link){
            if($this->checkArrayForValue($this->crawledLinks, 'href', $link['href']) === false){
    ...
    {
        array_push($this->crawledLinks, $page->getRootUrl());
